...
| `APARA_BIND_HOST` | No | `127.0.0.1` (or `0.0.0.0` with auth) | Listen address. The Docker image sets this to `0.0.0.0`; override when running bare-metal and you need to listen on a specific interface. |
